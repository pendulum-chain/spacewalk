...
impl<C, B> VaultRegistry<C, B> {
	...
	pub fn new(client: Arc<C>) -> Self {
		VaultRegistry { client, _marker: Default::default() }
	}
}
...
where
	...
	C::Api:
		VaultRegistryRuntimeApi<Block, VaultId, Balance, UnsignedFixedPoint, CurrencyId, AccountId>,
	VaultId: Codec,
	Balance: Codec + MaybeDisplay + MaybeFromStr,
	UnsignedFixedPoint: Codec + MaybeDisplay + MaybeFromStr,
	CurrencyId: Codec,
