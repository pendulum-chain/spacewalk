...
pub mod pallet {
	...
	pub type TotalStake<T: Config<I>, I: 'static = ()> =
		StorageValue<_, SignedFixedPoint<T, I>, ValueQuery>;
...
impl<T: Config<I>, I: 'static> Pallet<T, I> {
	...
	pub fn deposit_stake(
		...
		Self::deposit_event(Event::<T, I>::DepositStake { reward_id: reward_id.clone(), amount });
	...
	pub fn withdraw_stake(
		...
		Self::deposit_event(Event::<T, I>::WithdrawStake { reward_id: reward_id.clone(), amount });
		Ok(())
	}
