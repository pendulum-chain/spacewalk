...
impl_runtime_apis! {
	...
	impl sp_api::Metadata<Block> for Test {
		fn metadata() -> OpaqueMetadata {
			OpaqueMetadata::new(Test::metadata().into())
		}
	}

	impl sp_block_builder::BlockBuilder<Block> for Test {
	...
	impl sp_transaction_pool::runtime_api::TaggedTransactionQueue<Block> for Test {
	...
	impl sp_offchain::OffchainWorkerApi<Block> for Test {
		fn offchain_worker(header: &<Block as BlockT>::Header) {
		Executive::offchain_worker(header)
}
	}

	impl sp_consensus_aura::AuraApi<Block, AuraId> for Test {
	...
	impl sp_session::SessionKeys<Block> for Test {
	...
	impl fg_primitives::GrandpaApi<Block> for Test {
	...
	impl frame_system_rpc_runtime_api::AccountNonceApi<Block, AccountId, Index> for Test {
		fn account_nonce(account: AccountId) -> Index {
			System::account_nonce(account)
		}
	}

	impl pallet_transaction_payment_rpc_runtime_api::TransactionPaymentApi<Block, Balance> for Test {
		fn query_info(
	...
	impl frame_benchmarking::Benchmark<Block> for Test {
		...
		fn dispatch_benchmark(
			...
			impl frame_system_benchmarking::Config for Test {}
			impl baseline::Config for Test {}
