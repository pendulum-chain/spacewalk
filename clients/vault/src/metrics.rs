...
use runtime::{
    ...
    CollateralBalancesPallet, CurrencyId, Error as RuntimeError, FeedValuesEvent,
    FixedU128, SpacewalkParachain, SpacewalkReplaceRequest, IssuePallet, IssueRequestStatus, OracleKey, RedeemPallet,
...
mod tests {
    ...
    fn dummy_redeem_request(status: RedeemRequestStatus, vault: VaultId) -> SpacewalkReplaceRequest {
