...
impl ScpMessageCollector {
	pub(crate) fn new(public_network: bool, stellar_history_archive_urls: Vec<String>) -> Self {
		ScpMessageCollector {
			envelopes_map: Default::default() ,//Arc::new(RwLock::new(EnvelopesMap::default())),
			txset_map: Default::default(), //Arc::new(RwLock::new(TxSetMap::default())),
			txset_and_slot_map: Default::default(), //Arc::new(RwLock::new(TxSetHashAndSlotMap::default())),
			last_slot_index: 0,
			public_network,
