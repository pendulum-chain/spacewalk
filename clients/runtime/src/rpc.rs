...
use subxt::{
	...
	Metadata, RpcClient, SubstrateExtrinsicParams, TransactionEvents, TransactionProgress,
};
...
cfg_if::cfg_if! {
	if #[cfg(feature = "standalone-metadata")] {
		...
		const DEFAULT_SPEC_NAME: &str = "standalone";
...
type RuntimeApi =
	metadata::RuntimeApi<SpacewalkRuntime, SubstrateExtrinsicParams<SpacewalkRuntime>>;
