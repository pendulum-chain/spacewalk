...
use crate::sdk::types::{AuthenticatedMessage, AuthenticatedMessageV0, HmacSha256Mac, MessageType, StellarMessage};
use std::fmt::Debug;
...
pub(crate) fn parse_authenticated_message(xdr_message: &[u8]) -> Result<(AuthenticatedMessageV0, MessageType), Error> {
