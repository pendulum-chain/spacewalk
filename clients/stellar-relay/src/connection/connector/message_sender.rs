...
use crate::{connection::flow_controller::MAX_FLOOD_MSG_CAP, handshake::create_auth_message, Error};
...
impl Connector {
    ...
    pub(super) async fn check_to_send_more(&mut self, message_type: MessageType) -> Result<(), Error> {
